...
var triggerPromiseReaction = function(reaction, argument) {
  enqueue(function() { promiseReactionJob(reaction, argument); });
};
...
var fulfillPromise = function(promise, value) {
  ...
  if (length > 0) {
    triggerPromiseReaction(promise._promise_fulfillReactions0, value);
    ...
    if (length > 1) {
      ...
      for (var i = 1; i < length; i++) {
        ...
        promise[2 * (i - 1)] = void 0;
        promise[2 * (i - 1) + 1] = void 0;
      }
...
var rejectPromise = function(promise, reason) {
  ...
  var length = promise._promise_state >>> 2;
  if (length > 0) {
    triggerPromiseReaction(promise._promise_rejectReactions0, reason);
    promise._promise_fulfillReactions0 = void 0;
    promise._promise_rejectReactions0 = void 0;
    if (length > 1) {
      var reactions = [];
      for (var i = 1; i < length; i++) {
        reactions.push(promise[2 * (i - 1) + 1]);
        promise[2 * (i - 1)] = void 0;
        promise[2 * (i - 1) + 1] = void 0;
      }
