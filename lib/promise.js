...
module.exports = function(opts) {
  ...
  // extra performance.
  var supportSpecies = !!opts.supportSpecies;
  // When this is false we assume promise subclass constructors have no
  // side effects.
  var strictConstructors = !!opts.strictConstructors;
  // When this is true, a new resolver is created for every Promise.
  var dontReuseResolvers = !!opts.dontReuseResolvers;
  ...
  var useES2015Class = !!opts.useES2015Class;
  ...
  var tryCatch1 = function tryCatch1(fn, arg) {
    try {
      return fn(arg);
    } catch (e) {
      errorObj.e = e;
  ...
  var tryCatch2 = function tryCatch2(fn, arg1, arg2) {
    try {
      return fn(arg1, arg2);
    } catch (e) {
      errorObj.e = e;
  ...
  var tryCatch2r = function tryCatch2r(fn, receiver, arg1, arg2) {
    try {
  ...
  var tryCatch1n = function tryCatch1n(Fn, arg1) {
    try {
      return new Fn(arg1);
    } catch (e) {
      errorObj.e = e;
  ...
  var TypeIsObject = function TypeIsObject(x) {
  ...
  var TypeIsNotObject = function TypeIsNotObject(val) {
  ...
  var promiseCheckAndResolve = function promiseCheckAndResolve(promise, value) {
  ...
  var promiseCheckAndReject = function promiseCheckAndReject(promise, value) {
    /* jshint bitwise: false */
    if ((promise._promise_state & 3) !== PROMISE_PENDING) { return; }
    promise._promise_state++; // Sets state to PROMISE_RESOLVING
  ...
  var promiseReactionResolve =
  function promiseReactionResolve(promiseCapability, handlerResult, noThrow) {
    if (promiseCapability.constructor === PromiseCapability) {
      var resolve = promiseCapability.resolve;
      if (noThrow) {
        if (tryCatch1(resolve, handlerResult) === errorObj) {
  ...
  function promiseReactionJob(handler, promiseCapability, argument) {
    ...
    if (handlerResult === errorObj) {
      ...
      return promiseReactionReject(promiseCapability, handlerResult, true);
    }
    return promiseReactionResolve(promiseCapability, handlerResult, true);
  };

  var PromiseReactionJobTask = function PromiseReactionJobTask() {
    this.handler = null;
    this.capability = null;
    this.argument = null;
  };
  // Note that this must never throw an exception, or it can
  // halt the asap queue.
  ...
  var getThen = function getThen(r) { return r.then; };

  var PromiseResolveThenableJobTask = function PromiseResolveThenableJobTask() {
    this.promise = null;
  ...
  var triggerPromiseResolveThenableJob =
  ...
  var resolvePromise = function resolvePromise(promise, resolution) {
